...
const classifyData = ["图书音像", "手机", "交通工具", "美妆个护", "艺术文玩", "玩具乐器", "租房", "数码", "服装鞋帽", "运动户外", "电脑", "平板电脑", "办公用品", "家用电器", "珠宝装饰", "技能服务", "其他分类"]
...
Page({
  ...
  setClassifyDetailName:function(e){
    console.log("进入classifyDetailName")
    var detailName = e.currentTarget.dataset.detailname
    app.globalData.classifyDetailName = detailName
